...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260304002352_AddFinalDecisionHistory")]
    partial class AddFinalDecisionHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Models.Applicant", b =>
                {
                    ...
                    b.Property<string>("RecruitmentCenter")
                        .HasMaxLength(200)
                        .IsUnicode(false)
                    ...
                    b.ToTable("Applicants", t =>
                        {
                            t.HasTrigger("trg_GenerateQueueNumber");
                        });
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Models.Archive", b =>
                {
                    ...
                    b.HasKey("ArchiveID", "ApplicantID", "DecisionID")
                        .HasName("PK_Archive_1");

                    b.HasIndex("ApplicantFileNumber");
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Models.EarClinicExam", b =>
                {
                    b.Property<int>("EarClinicID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EarClinicID"));
                    ...
                    b.Property<string>("LeftHearing")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("LeftNose")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("LeftTympanicMembrane")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("LeftWhisperTest")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("RightHearing")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("RightNose")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("RightTympanicMembrane")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("RightWhisperTest")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<bool?>("isLeftHugeMates")
                        .HasColumnType("bit");

                    b.Property<bool?>("isRightHugeMates")
                        .HasColumnType("bit");

                    b.HasKey("EarClinicID");

                    b.HasIndex("DoctorID");

                    b.HasIndex("ResultID");

                    b.ToTable("EarClinicExam", (string)null);
                });
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Models.EyeExam", b =>
                {
                    ...
                    b.Property<string>("ColorTestLeft")
                        .HasMaxLength(10)
                    ...
                    b.Property<string>("WorstRefractionLeft")
                        .HasMaxLength(100)
                        .IsUnicode(false)
                        .HasColumnType("varchar(100)");

                    b.Property<string>("WorstRefractionRight")
                        .HasMaxLength(100)
                        .IsUnicode(false)
                        .HasColumnType("varchar(100)");
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Models.FinalDecision", b =>
                {
                    ...
                    b.Property<bool>("IsExportedToRecruitment")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                    ...
                    b.Property<DateTime?>("ReceptionAddedAt")
                        .HasColumnType("datetime");

                    b.Property<int?>("ResultID")
                        .HasColumnType("int");

                    b.Property<DateTime?>("SupervisorAddedAt")
                        .HasColumnType("datetime");

                    b.Property<DateTime?>("SupervisorLastModifiedAt")
                        .HasColumnType("datetime");

                    b.HasKey("DecisionID", "OrthopedicExamID", "SurgicalExamID", "InternalExamID", "EyeExamID", "EarClinicID");

                    b.HasIndex("EarClinicID");
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Models.FinalDecisionHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NewResultDescription")
                        .HasMaxLength(100)
                        .IsUnicode(true)
                        .HasColumnType("nvarchar(100)");

                    b.Property<int?>("NewResultID")
                        .HasColumnType("int");

                    b.Property<string>("PreviousResultDescription")
                        .HasMaxLength(100)
                        .IsUnicode(true)
                        .HasColumnType("nvarchar(100)");

                    b.Property<int?>("PreviousResultID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_FinalDecisionHistory");

                    b.ToTable("FinalDecisionHistory", (string)null);
                });
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Models.Investigation", b =>
                {
                    ...
                    b.Property<string>("InvestigationReason")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Models.Refraction", b =>
                {
                    b.Property<int>("RefractionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RefractionID"));
                    ...
                    b.HasKey("RefractionID", "RefractionTypeID");
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Models.Archive", b =>
                {
                    b.HasOne("Infrastructure.Persistence.Models.Applicant", "ApplicantFileNumberNavigation")
                        .WithMany("ArchiveApplicantFileNumberNavigations")
                        .HasForeignKey("ApplicantFileNumber")
                        .HasPrincipalKey("FileNumber")
                        .IsRequired()
                        .HasConstraintName("FK_Archive_Applicants");

                    b.HasOne("Infrastructure.Persistence.Models.Applicant", "Applicant")
                        .WithMany("ArchiveApplicants")
                    ...
                    b.Navigation("ApplicantFileNumberNavigation");
                });
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Models.FinalDecision", b =>
                {
                    b.HasOne("Infrastructure.Persistence.Models.EarClinicExam", "EarClinic")
                        .WithMany("FinalDecisions")
                        .HasForeignKey("EarClinicID")
                        .IsRequired()
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Models.Applicant", b =>
                {
                    b.Navigation("ArchiveApplicantFileNumberNavigations");

                    b.Navigation("ArchiveApplicants");
                });
